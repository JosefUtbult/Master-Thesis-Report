...
% TODO: Change title
\def\thesistitle{Fitting cats into Tupperware containers}
...
\def\supervisors{Prof. Mittens}

% TODO: Change to `Supervisors:` if you have more than one
\def\supervisorstring{Supervisor:} 

% TODO: Change dedication
\def\dedication{To all those unfortunate felines that succumb to container-based incidents}
